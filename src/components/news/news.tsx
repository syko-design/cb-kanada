...
import { Header, Wrapper, NewsRows, ButtonMoreWrapper } from './news.styled'
import { newsProps } from '../../input/news.props'
import { Heading3, Heading5 } from '../shared/heading/heading'
import { NewsItem } from './newsItem'
import { ButtonAsLink } from '../shared/button/button'
...
export const News: React.FC<Props> = (props) => {
	return (
		<Wrapper id="news-section">
			...
			<ButtonMoreWrapper>
				<ButtonAsLink to={'/posts'}>Show More Posts</ButtonAsLink>
			</ButtonMoreWrapper>
		</Wrapper>
	)
}
